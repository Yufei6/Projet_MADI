        ...
        if np.random.uniform(0,1)<0.4:
            ...
            if np.random.uniform(0,1)<0.8: 
                ...
                if np.random.uniform(0,1)<0.9: 
                    ...
                    touche = 'Left'
    if touche == 'Up' and li>0 and g[li-1,cj,0]>0:
        PosY -= zoom*20
        cost[g[li-1,cj,0]]+=g[li-1,cj,1]        
    # deplacement vers le bas
    if touche == 'Down' and li<nblignes-1 and g[li+1,cj,0]>0:
        PosY += zoom*20
        cost[g[li+1,cj,0]]+=g[li+1,cj,1] 
    # deplacement vers la droite
    if touche == 'Right' and cj< nbcolonnes-1 and g[li,cj+1,0]>0:
        PosX += zoom*20
        cost[g[li,cj+1,0]]+=g[li,cj+1,1] 
    # deplacement vers la gauche
    if touche == 'Left' and cj >0 and g[li,cj-1,0]>0:
        PosX -= zoom*20
        cost[g[li,cj-1,0]]+=g[li,cj-1,1] 
